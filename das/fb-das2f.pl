...
diagram_fact(name, diagram_1, "hw").
...
diagram_fact(source, cell_17, cVRvWxy9wkcLxyWbIS20__2).
...
diagram_fact(synonym, cell_17, cVRvWxy9wkcLxyWbIS20__4).
diagram_fact(synonym, cell_18, cVRvWxy9wkcLxyWbIS20__2).
diagram_fact(synonym, cell_19, cVRvWxy9wkcLxyWbIS20__3).
...
diagram_fact(target, cell_17, cVRvWxy9wkcLxyWbIS20__3).
diagram_fact(target, cell_9, i5jZ3dy8F4nkPbaXPHF6__9).
diagram_fact(value, cell_10, "outh").
diagram_fact(value, cell_11, "world").
diagram_fact(value, cell_12, "inw").
diagram_fact(value, cell_13, "&lt;br&gt;&lt;div&gt;&lt;/div&gt;").
diagram_fact(value, cell_15, "go").
diagram_fact(value, cell_16, "inh").
diagram_fact(value, cell_18, "outw").
diagram_fact(value, cell_19, "outHW").
diagram_fact(value, cell_6, "hw").
...
diagram_fact(width, cell_11, 275).
...
das_fact(name, cell_10, "outh").
das_fact(name, cell_11, "world").
das_fact(name, cell_12, "inw").
das_fact(name, cell_13, "&lt;br&gt;&lt;div&gt;&lt;/div&gt;").
das_fact(name, cell_15, "go").
das_fact(name, cell_16, "inh").
das_fact(name, cell_18, "outw").
das_fact(name, cell_19, "outHW").
das_fact(name, cell_6, "hw").
...
das_fact(bbL,cell_18,560).
  das_fact(bbT,cell_18,485).
  das_fact(bbR,cell_18,600).
  das_fact(bbB,cell_18,525).
das_fact(bbL,cell_19,640).
  das_fact(bbT,cell_19,485).
  das_fact(bbR,cell_19,680).
...
das_fact(contains,cell_11,cell_18).
...
das_fact(direct_contains,cell_6,cell_17).
das_fact(codebox,cell_13,"&lt;br&gt;&lt;div&gt;&lt;/div&gt;").
